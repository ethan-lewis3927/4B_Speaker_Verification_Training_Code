...
parser.add_argument('--train_list',     type=str,   default="data/train_voxceleb2_list.txt",  help='Train list');

#parser.add_argument('--test_list',      type=str,   default="data/veri_voxceleb1_list.txt",   help='Evaluation list');
#parser.add_argument('--test_list',      type=str,   default="data/test_voxceleb1_list_female.txt",   help='Evaluation list');
#parser.add_argument('--test_list',      type=str,   default="data/test_voxceleb1_list_male.txt",   help='Evaluation list');
parser.add_argument('--test_list',      type=str,   default="data/test_one_pair_wav.txt",   help='Evaluation list');

parser.add_argument('--train_path',     type=str,   default="data/voxceleb2", help='Absolute path to the train set');
parser.add_argument('--test_path',      type=str,   default="data/voxceleb1_test_wav", help='Absolute path to the test set');
